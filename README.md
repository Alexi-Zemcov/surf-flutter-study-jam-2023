...
>
> Для меня не было цели полностью выполнить задание. Целью ставил продемонстрировать свои навыки в качестве кода, архитектуре, документации и написании тестов.

Ниже представлено само задание.
